          ...
          <div className="grid lg:grid-cols-2 gap-0 relative">
            <div className="p-8 lg:p-12">
              ...
              <p className="mt-4 text-muted-foreground">
                The complete career-focused syllabus covering manual accounting, Tally ERP, VAT/TDS,
                banking and year-end compliance — taught the way an actual office runs.
              </p>
              ...
              <div className="mt-7 grid grid-cols-2 gap-3">
                ...
                <div className="rounded-2xl glass p-4">
                  <div className="flex items-center gap-2 text-xs text-muted-foreground">
                    <Sparkles className="h-4 w-4" /> New Shift
                  </div>
              ...
              <div className="mt-7 flex items-end gap-3">
                ...
                <div className="rounded-full bg-emerald-500/15 px-2 py-0.5 text-xs font-semibold text-emerald-300 mb-1">
                  33% off
                </div>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <a
                  href="#contact"
                  className="group inline-flex items-center gap-2 rounded-2xl bg-gradient-brand px-6 py-3.5 font-medium text-white shadow-[0_18px_40px_-14px_oklch(0.62_0.23_27/0.7)] transition hover:translate-y-[-1px]"
                >
                  Enroll Now{" "}
            ...
            <div className="relative min-h-[360px] lg:min-h-full">
              <img
                src={courseImg}
                alt="Practical taxation training"
                loading="lazy"

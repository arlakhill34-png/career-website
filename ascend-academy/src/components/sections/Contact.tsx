      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="mt-5 font-display text-4xl sm:text-5xl font-bold">
            Visit us in <span className="text-gradient-brand">Tilottama</span>
          </h2>
        </div>
        ...
        <div className="grid lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <a
                href="tel:9857079552"
                className="group rounded-2xl glass-strong border-gradient p-5 hover:bg-white/[0.04] transition"
              >
                <div className="flex items-center gap-2 text-xs uppercase tracking-wider text-muted-foreground">
              ...
              <a
                ...
                className="group rounded-2xl border-gradient p-5 bg-gradient-brand text-white shadow-[0_20px_50px_-20px_oklch(0.62_0.23_27/0.6)]"
              >
          ...
          >
            ...
            <button
              type="submit"
              className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-brand px-4 py-3 font-medium text-white shadow-[0_15px_35px_-12px_oklch(0.62_0.23_27/0.7)] hover:translate-y-[-1px] transition"
            >
              {submitted ? (
                "Sent ✓ We'll call you"
              ) : (
            ...
            <div className="grid grid-cols-2 gap-2">
              <a
                href="tel:9857079552"
                className="inline-flex items-center justify-center gap-2 rounded-xl glass px-4 py-2.5 text-sm hover:bg-white/10 transition"
              >
                <Phone className="h-4 w-4" /> Call
              </a>
              <a

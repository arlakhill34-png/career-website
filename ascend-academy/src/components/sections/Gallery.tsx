        ...
        <div className="flex items-end justify-between mb-10 gap-4 flex-wrap">
          <div>
            ...
            <h2 className="mt-4 font-display text-4xl sm:text-5xl font-bold">
              Inside the <span className="text-gradient-brand">institute</span>
            </h2>
          </div>
        </div>
          ...
          {imgs.map((im, i) => (
            ...
            >
              <img
                ...
                alt={im.caption}
                loading="lazy"
                className={`w-full ${im.h} object-cover transition-all duration-700 group-hover:scale-110 group-hover:blur-0`}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-background/20 to-transparent opacity-90" />
              <figcaption className="absolute left-4 bottom-3 text-sm font-medium">
                {im.caption}
              </figcaption>
            </motion.figure>
          ))}

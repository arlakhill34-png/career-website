    ...
    <section id="home" className="relative isolate overflow-hidden pt-36 pb-24 lg:pt-44 lg:pb-32">
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center relative">
        ...
        <div className="lg:col-span-6">
          ...
          >
            Master <span className="text-gradient-brand">Practical Accounting</span> & Taxation
            Skills
          </motion.h1>
          ...
          >
            Job-oriented practical based Accounting, VAT, TDS &amp; Taxation training designed for
            real career growth.
          </motion.p>
          ...
          <div className="mt-10 flex items-center gap-5 text-xs text-muted-foreground">
            <div className="flex items-center gap-2">
              <BadgeCheck className="h-4 w-4 text-brand-blue" /> Certified Trainers
            </div>
            <div className="flex items-center gap-2">
              <BadgeCheck className="h-4 w-4 text-brand-blue" /> Real Office Practice
            </div>
            <div className="flex items-center gap-2">
              <BadgeCheck className="h-4 w-4 text-brand-blue" /> Job Support
            </div>
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              <div className="mt-4 grid grid-cols-3 gap-3 text-xs">
                <div className="rounded-xl bg-white/5 p-2.5">
                  ...
                  <div className="font-semibold mt-0.5">12.4%</div>
                </div>
                <div className="rounded-xl bg-white/5 p-2.5">
                  <div className="text-muted-foreground">Net</div>
                  <div className="font-semibold mt-0.5">87.6%</div>
                </div>
                <div className="rounded-xl bg-white/5 p-2.5">
                  <div className="text-muted-foreground">Filed</div>
                  <div className="font-semibold mt-0.5">142</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3">
                <div className="grid h-10 w-10 place-items-center rounded-xl bg-brand-red/20 text-brand-red">
            ...
            >
              <div className="flex items-center gap-3">
                <div className="grid h-10 w-10 place-items-center rounded-xl bg-brand-blue/20 text-brand-blue">
